...
class Edge():
    ...
    def __init__(self, id, cids, shared_layers):
        ...
        self.shared_state_dict = self.get_model_parameters(shared_layers)  # since we are only passing the parameters between clients and servers instead of the whole model
        self.clock = []
